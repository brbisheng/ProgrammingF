...
def filling_the_blanks(question = easy_question_li, answers = easy_answers_li, nb_of_blanks = nb_easy):
    ...
    # I create and initialize the following variable to count total wrong guesses.
    ...
    while len(remaining) > 0:
        ...
        # The following while loop checks whether the index chosen by the users \
        ...
        while True:
            ...
            try:
                ...
                print "***please input a valid value from the following set: " + str(remaining)
            else:
                if int(blank_to_fill_nb) not in remaining:
                    print "***please input a valid value from the following set: " + str(remaining)
                else:
                    break
        ...
        # The following while loop checks whether the guess of user is correct.
        # If not correct, then the number of errors made will be recorded.
        
        while True:
            your_guess = raw_input("***Please input your guess: ") 
            if your_guess != answers[int(blank_to_fill_nb)-1]:
